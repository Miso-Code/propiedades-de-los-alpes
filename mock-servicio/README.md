...
### Comunicación BFF con WebSockets

Para probar la comunicación entre el BFF y el servicio de WebSockets, se puede agregar el siguiente request en Postman.
No se exportó la colección por limitaciones de Postman en cuanto a estos requests.
